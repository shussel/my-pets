    ...
    <div id="page" :class="{ dark: useDark }" :data-theme="settings.theme || 'default'">
        <div class="min-h-screen bg-slate-100 dark:bg-slate-900 dark:text-slate-200 pb-3 sm:p-4">
            <div class="w-full max-w-7xl mx-auto">
                <div class="fixed top-0 left-0 right-0 sm:pt-4 sm:pr-4 sm:pl-4 bg-slate-100 dark:bg-slate-900 z-50 lg:mx-auto max-w-7xl">
                    <nav class="bg-white dark:bg-slate-700 shadow-md sm:rounded-full">
