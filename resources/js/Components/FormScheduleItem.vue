    ...
    <div class="space-y-3">
        ...
        <template v-if="editItem.repeat && editItem.repeat !== 'once'">
            ...
            <div class="flex flex-wrap justify between gap-y-3">
                ...
                <div v-if="repeat.multi" class="grow min-w-1/2 text-center">
                ...
                <template v-if="!repeat.timesAny">
                    ...
                    <div v-if="hours.set" class="w-full flex items-center gap-2">
            ...
            <div v-if="editItem.repeat === 'times-per'">
                <InputLabel :value="'At Time' + (editItem.times?.length > 1 ? 's' : '')" class="w-full text-center"/>
